...
//    regionCommonRxBeaconSetup.Datarates = DataratesKZ865;
//    regionCommonRxBeaconSetup.Frequency = rxBeaconSetup->Frequency;
//    regionCommonRxBeaconSetup.BeaconSize = KZ865_BEACON_SIZE;
//    regionCommonRxBeaconSetup.BeaconDatarate = KZ865_BEACON_CHANNEL_DR;
//    regionCommonRxBeaconSetup.BeaconChannelBW = KZ865_BEACON_CHANNEL_BW;
